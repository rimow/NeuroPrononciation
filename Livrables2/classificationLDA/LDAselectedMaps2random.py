...
f_res.write('Conv1 \n')
interesting_maps = [5, 8, 11, 12, 16, 19, 21, 23, 24, 31, 33, 36, 41, 42, 50, 51, 55, 57, 58, 59, 61, 66, 75, 85, 87, 89, 92, 94, 95, 96, 99, 100, 103, 109, 114, 119, 120, 123]
...
interesting_maps = [5, 8, 11, 12, 16, 19, 21, 23, 24, 31, 33, 36, 41, 42, 50, 51, 55, 57, 58, 59, 61, 66, 68, 75, 85, 87, 89, 92, 94, 95, 96, 99, 100, 103, 109, 119, 120, 123]
interesting_maps = [int(elt) for elt in list(np.round(nb_f*rand(len(interesting_maps))-1))]
...
interesting_maps = [8, 9, 19, 22, 24, 31, 51, 56, 57, 80, 85, 95, 106, 115, 124]
interesting_maps = [int(elt) for elt in list(np.round(nb_f*rand(len(interesting_maps))-1))]
...
interesting_maps = [19, 22, 31, 51, 57, 80, 95, 106]
interesting_maps = [int(elt) for elt in list(np.round(nb_f*rand(len(interesting_maps))-1))]
...
interesting_maps = [56, 90, 115, 120]
interesting_maps = [int(elt) for elt in list(np.round(nb_f*rand(len(interesting_maps))-1))]
...
interesting_maps = [56, 80, 115, 119, 120]
interesting_maps = [int(elt) for elt in list(np.round(nb_f*rand(len(interesting_maps))-1))]
X, Y_c_inc,Y_r_v,Y_fr_jap = getData_onePerMap([conv1J],categories,['R'],a_ignorer=[],liste_cartes=interesting_maps)
score = LDAmeanScore(X,Y_c_inc,5);score_moyen = score_moyen+score;nb_scores=nb_scores+1
f_res.write('JAP, R, correct/incorrect : '+str(score)+'\n')

interesting_maps = [8, 11, 16, 19, 31, 32, 41, 56, 59, 75, 95, 96, 115, 120]
interesting_maps = [int(elt) for elt in list(np.round(nb_f*rand(len(interesting_maps))-1))]
...
interesting_maps = [11, 16, 19, 59, 75, 95, 96, 120]
interesting_maps = [int(elt) for elt in list(np.round(nb_f*rand(len(interesting_maps))-1))]
X, Y_c_inc,Y_r_v,Y_fr_jap = getData_onePerMap([conv1J],categories,['v'],a_ignorer=[],liste_cartes=interesting_maps)
score = LDAmeanScore(X,Y_c_inc,5);score_moyen = score_moyen+score;nb_scores=nb_scores+1
f_res.write('JAP, v , correct/incorrect :'+str(score)+'\n')
