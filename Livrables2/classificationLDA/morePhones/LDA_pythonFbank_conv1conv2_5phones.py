...
mapconv1F_file_newFbank = '../../maps2/maps5phones/BREF80_l_conv1_35maps_th0.500000.pkl'
mapconv2F_file_newFbank = '../../maps2/maps5phones/BREF80_l_conv2_35maps_th0.500000.pkl'
...
l_cartes = []
n_folds = 5
f_res = open('../../resultats/resultats_LDA/python_fbank/morePhonemes/LDA_resultats_fbank_python_conv1-2_dim10_5phones.txt', 'w') # To modify according to the repository
dim_reduction = 10
indices_corrects = [0]
