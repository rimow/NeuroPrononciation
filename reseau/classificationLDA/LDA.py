...
all_liste_dics = [[mpF],[mpJ],[mpJ,mpF]]
...
l_cartes = []
n_folds = 5
f_res = open('LDA_resultats_complet_mp22.txt', 'w')
...
for i,dics in enumerate(all_liste_dics):
    for j,ph in enumerate(all_listes_phonemes):
        for type in types:
            ...
            score1,score2 = ldaClassification(dics,liste_phonemes=ph,liste_categories=all_categories,num_cartes=l_cartes,a_ignorer=a_ignorer,n_folds=n_folds,type=type)
