...
analyse.pourcentage(Y,n_clusters,labels,"../classement",0,csv)
...
centroids = kmeans.cluster_centers_
labels = kmeans.labels_
analyse.pourcentage(Y,n_clusters,labels,"../classement",1,csv)
...
centroids = kmeans.cluster_centers_
labels = kmeans.labels_
analyse.pourcentage(Y,n_clusters,labels,"../classement",2,csv)
